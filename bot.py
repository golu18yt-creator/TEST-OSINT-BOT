...
def handle_message(update):
    ...
    # Agar bot off hai, toh kisi bhi message ya command ka response mat do
    if not BOT_ACTIVE:
        return
    ...
    if text == "⚡ Admin Panel" and is_admin:
        ...
        admin_info = (
            ...
            "<b>⚙️ Commands:</b>\n"
            "• <code>/botoff</code> - Turn off bot responses\n"
            "• <code>/boton</code> - Turn on bot responses\n"
...
def main():
    # Keep-alive Dummy Server Thread
    server_thread = threading.Thread(target=run_dummy_server, daemon=True)
    server_thread.start()

    print("Bot starting continuous polling loop (Always Awake Mode)...")
    offset = None
