...
# ---------------------------------------------------------
# REDEEM CODE FIX (STRIP & UPPER CASE)
# ---------------------------------------------------------
...
# ---------------------------------------------------------
# TELEGRAM API HELPERS & API TIMEOUT FIX
# ---------------------------------------------------------
...
# --- FIXED API FETCH FUNCTION (TIMEOUT 5 SEC) ---
...
def handle_message(update):
    ...
    # --- PHONE SEARCH LOGIC (FIXED) ---
        ...
        if text.isdigit() and len(text) == 10:
            ...
            # Fetch API data with 5s timeout
            api_data = fetch_phone_data(text)

            # Handle errors without sticking
            ...
            # Deduct credit only on successful search
            if not is_admin:
