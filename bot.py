...
def handle_message(update):
    ...
    if text == "⚡ Admin Panel" and is_admin:
        ...
        admin_info = (
            ...
            f"• <code>/resetgif</code> - Reset Welcome GIF/Video to default\n"
    ...
    # --- /resetgif COMMAND (Resets welcome media to default) ---
        ...
        send_message(chat_id, "🔄 <b>Welcome GIF/Video successfully default par reset kar diya gaya hai!</b>")
        return
...
def main():
    ...
    print("Bot starting continuous polling loop (Always Awake Mode with /resetgif)...")
    offset = None
